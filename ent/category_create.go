...
func (cc *CategoryCreate) SetNillableStatus(s *string) *CategoryCreate {
	if s != nil {
		cc.SetStatus(*s)
	}
	return cc
...
func (cc *CategoryCreate) SetLookupKey(s string) *CategoryCreate {
...
func (cc *CategoryCreate) AddInternshipIDs(ids ...string) *CategoryCreate {
	cc.mutation.AddInternshipIDs(ids...)
	return cc
}

// AddInternships adds the "internships" edges to the Internship entity.
func (cc *CategoryCreate) AddInternships(i ...*Internship) *CategoryCreate {
	ids := make([]string, len(i))
	for j := range i {
		ids[j] = i[j].ID
	}
	return cc.AddInternshipIDs(ids...)
}
...
func (cc *CategoryCreate) check() error {
	...
	if _, ok := cc.mutation.LookupKey(); !ok {
		return &ValidationError{Name: "lookup_key", err: errors.New(`ent: missing required field "Category.lookup_key"`)}
	}
	if v, ok := cc.mutation.LookupKey(); ok {
...
func (cc *CategoryCreate) createSpec() (*Category, *sqlgraph.CreateSpec) {
	...
	if nodes := cc.mutation.InternshipsIDs(); len(nodes) > 0 {
