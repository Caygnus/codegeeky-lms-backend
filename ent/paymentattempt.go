...
func (*PaymentAttempt) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case paymentattempt.FieldID, paymentattempt.FieldStatus, paymentattempt.FieldCreatedBy, paymentattempt.FieldUpdatedBy, paymentattempt.FieldPaymentID, paymentattempt.FieldPaymentStatus, paymentattempt.FieldGatewayAttemptID, paymentattempt.FieldErrorMessage:
