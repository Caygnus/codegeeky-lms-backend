...
func (pc *PaymentCreate) SetDestinationType(tdt types.PaymentDestinationType) *PaymentCreate {
	pc.mutation.SetDestinationType(tdt)
	return pc
}
...
func (pc *PaymentCreate) SetPaymentMethodType(tmt types.PaymentMethodType) *PaymentCreate {
	pc.mutation.SetPaymentMethodType(tmt)
	return pc
}
...
func (pc *PaymentCreate) SetCurrency(t types.Currency) *PaymentCreate {
	pc.mutation.SetCurrency(t)
	return pc
}
...
func (pc *PaymentCreate) check() error {
	...
	if v, ok := pc.mutation.Currency(); ok {
		if err := payment.CurrencyValidator(string(v)); err != nil {
