...
func (pu *PaymentUpdate) SetNillablePaymentMethodType(tmt *types.PaymentMethodType) *PaymentUpdate {
	if tmt != nil {
...
func (pu *PaymentUpdate) SetPaymentStatus(ts types.PaymentStatus) *PaymentUpdate {
	pu.mutation.SetPaymentStatus(ts)
	return pu
}

// SetNillablePaymentStatus sets the "payment_status" field if the given value is not nil.
func (pu *PaymentUpdate) SetNillablePaymentStatus(ts *types.PaymentStatus) *PaymentUpdate {
	if ts != nil {
		pu.SetPaymentStatus(*ts)
	}
	return pu
}
...
func (pu *PaymentUpdate) check() error {
	...
	if v, ok := pu.mutation.PaymentStatus(); ok {
		if err := payment.PaymentStatusValidator(string(v)); err != nil {
...
// SetNillablePaymentMethodType sets the "payment_method_type" field if the given value is not nil.
func (puo *PaymentUpdateOne) SetNillablePaymentMethodType(tmt *types.PaymentMethodType) *PaymentUpdateOne {
	if tmt != nil {
...
// SetPaymentStatus sets the "payment_status" field.
func (puo *PaymentUpdateOne) SetPaymentStatus(ts types.PaymentStatus) *PaymentUpdateOne {
	puo.mutation.SetPaymentStatus(ts)
	return puo
}

// SetNillablePaymentStatus sets the "payment_status" field if the given value is not nil.
func (puo *PaymentUpdateOne) SetNillablePaymentStatus(ts *types.PaymentStatus) *PaymentUpdateOne {
	if ts != nil {
		puo.SetPaymentStatus(*ts)
	}
	return puo
}
